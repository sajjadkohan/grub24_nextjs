    ...
    <div className={styles.termsView}>
        <div className={`container`}>
            <div className={`${styles.viewContent} ${styles.bnh}`}>
                ...
                <p>
                Your privacy is important to us. It is Grub24's policy to respect your privacy and comply with any applicable law and regulation regarding any personal information we may collect about you, including across our website, https://grub24.co.uk/, and other sites we own and operate. 
                <br /><br />
                ...
                <br /><br />
                This policy is effective as of 25 April 2022. 
                <br />
                ...
                <ul style={{paddingLeft:"30px"}}>
                    ...
                    <li>Data we collect can depend on the individual settings of your device and software. We recommend checking the policies of your device manufacturer or software provider to learn what </li>
                    <li>information they make available to us. </li>
                </ul>
                </p>
                ...
                <ul style={{paddingLeft:"30px"}}>
                    ...
                    <li>We may combine voluntarily provided and automatically collected personal information with general information or research data we receive from other trusted sources. For example, If you provide us with your location, we may combine this with general information about currency and language to provide you with an enhanced experience of our site and service. </li>
                </ul>
                </p>
                ...
                <br/><br/>
                    <ul style={{paddingLeft:"30px"}}>
                        ...
                        <li>Third parties we currently use include: </li>
                        <br/>
                        <li>Google Analytics</li>
                        <li>pagesense</li>
                        <li>elasticMail</li>
                        <li>Zoho marketing</li>
                        <li>Stripe</li>
                    </ul>
                </p>
                ...
                <p>
                <span className={styles.titSpan}>Your choice :</span> By providing personal information to us, you understand we will collect, hold, use, and disclose your personal information in accordance with this privacy policy. You do not have to provide personal information to us, however, if you do not, it may affect your use of our website or the products and/or services offered on or through it. 
                </p>

                <p>
                <span className={styles.titSpan}>Information from third parties : </span>
                If we receive personal information about you from a third party, we will protect it as set out in this privacy policy. If you are a third party providing personal information about somebody else, you represent and warrant that you have such person’s consent to provide the personal information to us. 
                </p>

                <p>
                    <span className={styles.titSpan}>Marketing permission :</span>
                ...
                <p>
                    <span className={styles.titSpan}>Access :</span>
                    You may request details of the personal information that we hold about you.
                </p>
                
                <p>
                    <span className={styles.titSpan}>Correction :</span>
                    If you believe that any information we hold about you is inaccurate, out of date, incomplete, irrelevant, or misleading, please contact us using the details provided in this privacy policy. We will take reasonable steps to correct any information found to be inaccurate, incomplete, misleading, or out of date. 
                </p>

                <p>
                    <span className={styles.titSpan}>Non-discrimination :</span>
                ...
                <h2>Your Account</h2>
                <p>
                You have the right to request the deletion of the personal data we hold about you. If you wish to delete your account and any personal data relating to you, you can do so at any time by signing in and going to your profile ‘settings’ page. Select ‘delete account’. Your account and personal data will be permanently deleted. Alternatively, please email support@grub24.co.uk to request deletion of your account and personal data. 
                </p>
                ...
                <br/><br/>
                Administrator<br/>
                https://grub24.co.uk/page-contact 
                </p>
            </div>
        </div>
    </div>
