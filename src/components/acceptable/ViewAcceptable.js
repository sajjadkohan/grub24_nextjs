...
import styles from "./acceptable.module.css"

const ViewAcceptable = () => {
  return (
    <div className={styles.termsView}>
        <div className={`container`}>
            <div className={`${styles.viewContent} ${styles.bnh}`}>
                ...
                <p>
                This acceptable use policy covers the products, services, and technologies (collectively referred to as the “Products”) provided by Grub24 under any ongoing agreement. It’s designed to protect us, our customers and the general Internet community from unethical, irresponsible and illegal activity. 
                <br/><br/>
                Grub24 customers found engaging in activities prohibited by this acceptable use policy can be liable for service suspension and account termination. In extreme cases, we may be legally obliged to report such customers to the relevant authorities. 
                <br/><br/>
                This policy was last reviewed on 25 April 2022. 
                </p>
                ...
                <h4>Unauthorised use of Grub24 property</h4>
                <p>
                We prohibit the impersonation of Grub24, the representation of a significant business relationship with Grub24, or ownership of any Grub24 property (including our Products and brand) for the purpose of fraudulently gaining service, custom, patronage or user trust. 
                </p>
